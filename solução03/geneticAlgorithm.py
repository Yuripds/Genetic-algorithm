...
def run(fitFunction, n_iter, populacao_01, populacao_02 , crossRate, mutationRate,gama):


    
    cont = 0
    best = 0
    best_eval = fitFunction(populacao_01[0],populacao_02[0],gama)
    population = population.tolist()


##### analisar e mudar código a partir daqui
    while (cont < n_iter):
